...
cc -Wall -Wextra -Wpedantic  -lssl-dv -lcrypto-dv -lgetdns -o openssl-demo-server main.o ocsp-stapling.o dnssec-chain-extension.o
```
Debian build:
```
sbuild -s --force-orig-source -A --arch amd64 -d stretch
...
Usage: openssl-demo-server [options]
  ...
  -sname <name>   server name               default: dimos
...
Bugs:
I'm sure there are some ... For that DO NOT USE that software on a production level system.
